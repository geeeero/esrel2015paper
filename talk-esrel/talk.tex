...
GBR (Walley 1991) ensures \emph{coherence} {\small (a consistency property)}\\[1ex]}
\uncover<3->{%
Walter \& Augustin (2009), Walter (2013): $\PZ = [\nzl, \nzu] \times [\yzl, \yzu]$\\
gives tracktability \& meaningful reaction to prior-data conflict:
\begin{itemize}
...
\item[\play]<7-> Use model for maintenance planning
\end{itemize}}};
\end{tikzpicture}
}
