...
\uncover<2-3>{\node at (6,0) {\includegraphics[height=0.6\textheight,trim = 300 150 290 820, clip]{../poster-system/poster-system}};}
\uncover<3->{\node at (0,0) {\includegraphics[width=0.5\textwidth,trim = 50 400 520 610, clip]{../poster-system/poster-system}};}
\end{tikzpicture}
}
