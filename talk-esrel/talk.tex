...
[pfeil/.style={-latex', line width=1mm, color=tuered, shorten <=1mm},
 ...
 redbrace/.style={draw=tuered, decoration=brace, decorate, line width=0.8mm},
 redbox/.style={text centered, draw=tuered, inner sep=1mm, very thick}]
\uncover<1-1>{\node at (0,0) {\includegraphics[width=0.95\textwidth]{sysex1-1}};}
\uncover<1-4>{\node at (2.5, 2.5) {\parbox{0.5\textwidth}{\color{tuered}\small $\ell=3$ components, $\nz \in [2, 5]$,\\
                                                                              $\yz = \E[\lambda] \in [103, 154]$ (9--11 weeks)}};}
\uncover<2-2>{\node at (0,0) {\includegraphics[width=0.95\textwidth]{sysex1-2}};}
\uncover<2-4>{\node at (3.5, 1.5) {\parbox{0.25\textwidth}{\color{tuecyan}\small $\mbf{t} = (10,11,11^+)$}};}
