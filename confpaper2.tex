...
In reliability engineering, the goal is often to describe the reliability of a complex system.
...
Often, there is no failure data for the system itself (i.e., if the system is new-built),
but for the components the system is made of some data about failure times exists.
Information on the failure distribution of the components can then be used to
derive the distribution of $T_\text{sys}$.
...
using the survival signature. ***citations***
