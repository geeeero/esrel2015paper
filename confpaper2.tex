...
As we will show in Section~\ref{sec:modforsurpr}, when taking the standard choice of a conjugate prior,
...
This behaviour is obtained by a specific choice for the set of priors \cite{Walter2009a,diss}
...
(general problem, see my papers and diss).
