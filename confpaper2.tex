...
and Eq.~\ref{eq:weibull-pdf-cdf} in the last step.
%
...
***Consider set of priors,
let $\nz$ and $\yz$ vary in intervals like in \eqref{eq:setofpriors}.

***Lower and upper reliability bounds by minimizing and maximizing \eqref{eq:generalformula}
over $[\nzl, \nzu] \times [\yzl, \yzu]$ for each $t > t_\text{now}$.


***selection of Andrew's examples
