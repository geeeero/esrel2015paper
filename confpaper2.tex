...
we predict, e.g., $\Fsys(15) = P(T_\text{sys} \leq 15) = [***, ***]$.
After observing $\vec{t}_2^3$, i.e.\ at current time $11$,
we have instead $\Fsys(15 \mid \vec{t}_2^3) = P(T_\text{sys} \leq 15 \mid \vec{t}_2^3) = [***, ***]$.
...
is $[\lFsys(15 \mid \vec{t}_2^3), \uFsys(15 \mid \vec{t}_2^3)] = [0.86***, 0.97***]$.
...
is $[\lRsys(10 \mid \vec{t}_2^3), \uRsys(10 \mid \vec{t}_2^3)] = [0.16***,0.39***]$,
