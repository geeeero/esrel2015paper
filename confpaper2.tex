...
In this paper we explored a robust Bayesian approach to reliability estimation for a simple parallel system,
and showed how the use of sets of prior distributions results in increased imprecision,
i.e.\ more cautious probability statements, in case of prior-data conflict.
